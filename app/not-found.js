  ...
  return (
    <main className="relative min-h-[70vh] grid place-items-center py-20 dots-soft">
      <div className="mx-auto max-w-xl px-4 sm:px-6 text-center">
        ...
        <h1 className="mt-4 font-display font-bold text-3xl sm:text-5xl tracking-tight">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link href="/attractions" className="rounded-full px-5 py-2.5 font-bold bg-cream-50 border-2 border-ink-950 hover:bg-ink-950 hover:text-cream-50 transition">
            See what's on
          </Link>
          <Link href="/contact" className="rounded-full px-5 py-2.5 font-bold bg-cream-50 border-2 border-ink-950 hover:bg-ink-950 hover:text-cream-50 transition">
            Find us
          </Link>
        </div>
      </div>

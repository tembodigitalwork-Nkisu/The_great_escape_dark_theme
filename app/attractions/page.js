...
const proHeadline = [
  {
    name: "PGA Golf Simulator",
    blurb: "Tee off on famous courses worldwide with PGA-licensed software. Sessions in 15-min blocks up to a full hour.",
    price: "From K—",
    ages: "10+",
    duration: "15–60 min",
    intensity: "Chill",
    accent: "green",
    bookType: "Golf Simulator",
  },
  {
    name: "VR Racing Cockpits",
    blurb: "Real car cockpits with motion feedback. The most immersive racing experience in Zambia.",
    price: "From K—",
    ages: "12+",
    duration: "Per race",
    intensity: "Thrilling",
  ...
  {
    name: "VR Bay",
    blurb: "Rotating library of VR titles — rollercoasters, action games, exploration. Most advanced setup in Lusaka.",
    price: "From K—",
    ages: "10+",
  ...
  {
    name: "Bowling Alley",
    blurb: "Full alley with automatic scoring. Walk-in lanes plus reservable for groups and parties.",
    price: "From K—",
    ages: "All ages",
    duration: "Per game",
    intensity: "Chill",
...
const noobLineup = [
  {
    name: "Soft Play",
    blurb: "Padded play zone for the smallest ones. Climb, slide, crawl — with our staff keeping watch.",
    price: "Per session",
    ages: "2–6",
    intensity: "Chill",
    accent: "yellow",
  ...
  {
    name: "Bumper Cars",
    blurb: "Pad up, pile in, bump everyone you love. A kids' favourite.",
    price: "Per ride",
    ages: "5+",
    intensity: "Thrilling",
    accent: "red",
    bookType: "Bumper Cars",
  },
  {
    name: "Mini Bikes",
    blurb: "Pint-sized rides for pint-sized riders. Safe, supervised, and a guaranteed photo op.",
    price: "Per ride",
    ages: "3–8",
    intensity: "Chill",
    accent: "green",
  ...
  {
    name: "Merry-Go-Round",
    blurb: "The classic. Lights, music, the whole spin.",
    price: "Per ride",
    ages: "2–8",
    intensity: "Chill",
    accent: "blue",
    bookType: "Merry-Go-Round",
  },
  {
    name: "Virtual Rollercoaster",
    blurb: "Our viral TikTok favourite — strap in, look down, scream tactically.",
    price: "Per ride",
    ages: "8+",
    intensity: "Thrilling",
    accent: "red",
    bookType: "Virtual Rollercoaster",
  },
  {
    name: "Classic Arcade",
    blurb: "Retro and modern arcade machines, token-fed and ready when you are.",
    price: "Per game",
    ages: "All ages",
    intensity: "Chill",
    accent: "yellow",
    ...
    <main>
      ...
      <section className="relative py-16 sm:py-20 bg-escape-blue text-cream-50 border-y-2 border-ink-950">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-12 rounded-3xl border-2 border-ink-950 bg-cream-50 text-ink-950 p-6 sm:p-8 shadow-pop">
            <h3 className="font-display font-bold text-2xl">Pro Level simulator games · K38.99 each</h3>
            <p className="mt-2 text-ink-950/70">Eight rotating titles in the upstairs racing and motion bays.</p>
            <ul className="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm">
              {proSimulators.map((g) => (
                <li key={g} className="rounded-xl border-2 border-ink-950 bg-cream-50 px-3 py-2 font-semibold text-center">
                  {g}
                </li>
              ))}
            </ul>

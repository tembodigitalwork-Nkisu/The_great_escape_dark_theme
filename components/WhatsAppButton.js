...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-hidden={hidden}
      tabIndex={hidden ? -1 : 0}
      className={`fixed bottom-5 right-5 z-50 h-14 w-14 rounded-full bg-[#25D366] grid place-items-center shadow-lg ring-2 ring-ink-950 transition-all duration-300 ${
